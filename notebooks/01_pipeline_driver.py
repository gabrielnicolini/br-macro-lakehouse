...
write_delta_table(spark.createDataFrame(fx_daily_pd), cfg.fqtn(cfg.bronze_fx_daily), mode="overwrite")
write_delta_table(spark.createDataFrame(ipca_pd), cfg.fqtn(cfg.bronze_ipca_monthly), mode="overwrite")
write_delta_table(spark.createDataFrame(tax_pd), cfg.fqtn(cfg.bronze_wdi_taxes), mode="overwrite")
...
write_delta_table(spark.createDataFrame(fx_monthly_pd), cfg.fqtn(cfg.silver_fx_monthly), mode="overwrite")
write_delta_table(spark.createDataFrame(ipca_silver_pd), cfg.fqtn(cfg.silver_ipca), mode="overwrite")
write_delta_table(spark.createDataFrame(tax_silver_pd), cfg.fqtn(cfg.silver_taxes_yearly), mode="overwrite")
...
write_delta_table(spark.createDataFrame(gold_pd), cfg.fqtn(cfg.gold_mart_monthly), mode="overwrite")
